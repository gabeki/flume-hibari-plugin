...
public class HibariResponse implements TBase<HibariResponse, HibariResponse._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("HibariResponse");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(HibariResponse.class, metaDataMap);
  }

  public HibariResponse() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public HibariResponse(HibariResponse other) {
  ...
  public HibariResponse deepCopy() {
    return new HibariResponse(this);
  }

  @Deprecated
  public HibariResponse clone() {
    return new HibariResponse(this);
  }
  ...
  public HibariResponse setTimestamp(long timestamp) {
  ...
  public HibariResponse setKey(ByteBuffer key) {
    this.key = key;
    return this;
  }
  ...
  public HibariResponse setValue(ByteBuffer value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof HibariResponse)
      return this.equals((HibariResponse)that);
    return false;
  }

  public boolean equals(HibariResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(HibariResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    HibariResponse typedOther = (HibariResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HibariResponse(");
    boolean first = true;
