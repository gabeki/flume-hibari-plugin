...
public class Add implements TBase<Add, Add._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("Add");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(Add.class, metaDataMap);
  }
  ...
  public Add setTable(String table) {
    this.table = table;
    return this;
  }
  ...
  public Add setKey(ByteBuffer key) {
    this.key = key;
    return this;
  }
  ...
  public Add setValue(ByteBuffer value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object that) {
    ...
    if (that instanceof Add)
      return this.equals((Add)that);
    return false;
  }

  public boolean equals(Add that) {
    if (that == null)
      return false;
